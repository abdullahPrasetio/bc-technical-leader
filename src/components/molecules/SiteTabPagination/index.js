    ...
    return (
        <div>
            <div className="flex justify-end mb-4 px-5">
                {/* <SmallModal
                    visible={visible}
                    labelButton="Create Site"
                    modalTitle="Create Site"
                    modalContent={
                        <FormSite
                            key={1}
                            onSubmitData={(value) => setVisible(value)}
                        />
                    }
                /> */}
                <Link
                    to={`/customer/site/create/${id}`}
...
export default withRouter(SiteTabPagination)
