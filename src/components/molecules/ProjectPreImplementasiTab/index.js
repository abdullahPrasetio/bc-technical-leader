...
import PreImplementasiTabs from '../PreImplementasiTabs'
function ProjectPreImplementasiTab({ id, dataSite, dataUnit, project }) {
    ...
    return (
        <>
            ...
            <div className="rounded px-3 py-2 flex flex-wrap bg-blue mt-10">
...
export default ProjectPreImplementasiTab
